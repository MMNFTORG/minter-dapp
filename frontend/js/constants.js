const contractAddress = "0x0335c79D54706B2e97E691f16fbe519A342a580A"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the MMNFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'COLLECT RARE ORIGINAL HAND DRAWN NFT ARTS WITH MILLIONAIRE MENTOR';
const h1_presale_coming_soon = "MMNFT Drop Coming Soon!!";
const h1_presale_mint = "MMNFT Pre-Sale Minting Open!!";
const h1_public_mint = "Public Minting Open!!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "We are working hard to launch the MMNFT Collection. Stay tuned for updates!";
...
const button_presale_coming_soon = "Get on the MMNFT Whitelist";
const button_presale_mint_whitelisted = "Mint Your Special MMNFT";
const button_presale_mint_not_whitelisted = "Get on the Whitelist";
const button_presale_already_minted = "Join The Community";
const button_public_mint = "Mint Your MMNFT";
